...
tested_parameter = ["64, 16", "32, 32", "64, 64", "128, 64", "16, 16, 16", "32, 16, 16", "32, 32, 16", "32, 16, 8, 8", "16, 8, 8, 8", "32, 8, 4, 4, 4"]
episodes_limit = 1000
coins_in_level = 2
nr_of_workers = 10
...
for j in range(0, nr_of_workers, nr_of_plots):
    ...
    pylab.xticks([i for i in range(-0, 1100, 100)])
    ...
    pylab.savefig("WykresGen7x7Proba1.png")
    pylab.show()
