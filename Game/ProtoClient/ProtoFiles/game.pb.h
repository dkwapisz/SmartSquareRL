...
PROTOBUF_NAMESPACE_OPEN
        template<>
        ::GameMessage::Action *Arena::CreateMaybeMessage<::GameMessage::Action>(Arena *);

        template<>
        ::GameMessage::Reset *Arena::CreateMaybeMessage<::GameMessage::Reset>(Arena *);

        template<>
        ::GameMessage::State *Arena::CreateMaybeMessage<::GameMessage::State>(Arena *);

        template<>
        ::GameMessage::State_Direction *Arena::CreateMaybeMessage<::GameMessage::State_Direction>(Arena *);
PROTOBUF_NAMESPACE_CLOSE
namespace GameMessage {
    ...
    inline void State::set_allocated_closestobstacle(::GameMessage::State_Direction *closestobstacle) {
        ...
        if (closestobstacle) {
            ::PROTOBUF_NAMESPACE_ID::Arena *submessage_arena =
                    ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::GameMessage::State_Direction>::GetOwningArena(
                            closestobstacle);
...
PROTOBUF_NAMESPACE_OPEN
        ...
        template<>
        struct is_proto_enum<::GameMessage::Action_ActionDirection> : ::std::true_type {
        };
